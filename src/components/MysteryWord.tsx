...
import mw_1 from '../assets/mysteryword/mysteryword_1.png';
import mw_V1 from '../assets/mysteryword/mysteryword_v1.mp4';
import mw_V2 from '../assets/mysteryword/mysteryword_v2.mp4';
import mw_2 from '../assets/mysteryword/mysteryword_ftw.jpg';
import mw_3 from '../assets/mysteryword/mysteryword_21.png';
import mw_V3 from '../assets/mysteryword/mysteryword_v3.mp4';
    ...
    <div className='container-template'>
      <div className='mw700 pb'>
        ...
        <div>
          ...
          <img src={mw_1} alt="" />
          <figcaption>Bookworm Adventures @ PopCap Games</figcaption>
        ...
        <div>
          ...
          <video autoPlay loop muted>
            <source src={mw_V3} type='video/mp4' />
            Your browser does not support the video tag.
          </video>
        </div>
        <div>
